...
public class RecipeAddEditActivity extends AppCompatActivity {
    ...
    // Code to get ingredient from add ingredient activity
    ...
    /**
     * Function to call on add ingredient activity
     * @param v
     *    View that the onClick is linked to
     */
    ...
    // Code to get image from add photo from photo gallery
